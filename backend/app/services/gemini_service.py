...
{{
  ...
  "need_type": "one of: HEALTHCARE, EDUCATION, WATER_SANITATION, SHELTER, FOOD, INFRASTRUCTURE, LIVELIHOOD, FLOOD, FLASH_FLOOD, CYCLONE, EARTHQUAKE, TSUNAMI, LANDSLIDE, AVALANCHE, DROUGHT, HEATWAVE, COLDWAVE, LIGHTNING, FOREST_FIRE, CLOUDBURST, GLOF, INDUSTRIAL_ACCIDENT, CHEMICAL_LEAK, GAS_LEAK, NUCLEAR_INCIDENT, BUILDING_COLLAPSE, MINE_ACCIDENT, TRANSPORT_ACCIDENT, OIL_SPILL, FIRE_INCIDENT, TERROR_ATTACK, STAMPEDE, EPIDEMIC, PANDEMIC, OUTBREAK, TOXIC_EXPOSURE",
  ...
  "original_language": "detected language code (hi, en, mr, ta, etc.)"
    ...
    def _fallback_extract(self, raw_text: str) -> Dict[str, Any]:
        ...
        type_keywords = {
            ...
            "FLOOD": ["flood", "flooding", "waterlogging", "inundated", "submerged", "river overflow"],
            "FLASH_FLOOD": ["flash flood", "cloudburst flood", "sudden torrent"],
            "CYCLONE": ["cyclone", "typhoon", "hurricane", "strong winds", "storm surge"],
            "EARTHQUAKE": ["earthquake", "quake", "tremor", "seismic", "shaking"],
            "TSUNAMI": ["tsunami", "tidal wave", "harbor wave"],
            "LANDSLIDE": ["landslide", "mudslide", "rockfall", "debris flow"],
            "AVALANCHE": ["avalanche", "snowslide", "snow collapse"],
            "DROUGHT": ["drought", "dry spell", "water scarcity", "crop failure", "no rain"],
            "HEATWAVE": ["heatwave", "extreme heat", "sunstroke", "lo winds", "dehydration"],
            "COLDWAVE": ["coldwave", "extreme cold", "frost", "freezing temperature"],
            "LIGHTNING": ["lightning", "thunderbolt", "electrocution stroke"],
            "FOREST_FIRE": ["forest fire", "wildfire", "bushfire", "jungle fire"],
            "CLOUDBURST": ["cloudburst", "heavy downpour", "torrential rain"],
            "GLOF": ["glof", "glacial lake", "moraine outburst"],
            "INDUSTRIAL_ACCIDENT": ["industrial accident", "factory explosion", "boiler blast"],
            "CHEMICAL_LEAK": ["chemical leak", "chemical spill", "toxic leak"],
            "GAS_LEAK": ["gas leak", "lpg leak", "gas inhalation", "suffocation"],
            "NUCLEAR_INCIDENT": ["nuclear incident", "radiation leak", "reactor safety"],
            "BUILDING_COLLAPSE": ["building collapse", "roof collapse", "structural failure"],
            "MINE_ACCIDENT": ["mine accident", "mining blast", "mine cave-in", "coal mine flooding"],
            "TRANSPORT_ACCIDENT": ["transport accident", "derailment", "plane crash", "bus accident", "collision"],
            "OIL_SPILL": ["oil spill", "crude leak", "marine pollution"],
            "FIRE_INCIDENT": ["fire incident", "blaze", "fire breakout", "short circuit fire"],
            "TERROR_ATTACK": ["terror attack", "blast", "shooting", "explosion hostiles"],
            "STAMPEDE": ["stampede", "crowd crush", "temple rush"],
            "EPIDEMIC": ["epidemic", "cholera", "malaria", "dengue outbreak", "measles spreading"],
            "PANDEMIC": ["pandemic", "viral spread", "quarantine lock"],
            "OUTBREAK": ["outbreak", "disease spread", "food poisoning", "infections"],
            "TOXIC_EXPOSURE": ["toxic exposure", "poisonous gas", "chemical poisoning"],
        }
        ...
        skill_map = {
            ...
            "FLOOD": ["rescue_swimmer", "boat_handling", "relief_distribution"],
            "FLASH_FLOOD": ["rescue_swimmer", "first_aid", "logistics"],
            "CYCLONE": ["rescue", "debris_clearance", "shelter_management"],
            "EARTHQUAKE": ["search_and_rescue", "structural_assessment", "first_aid"],
            "TSUNAMI": ["coastal_rescue", "emergency_medical", "logistics"],
            "LANDSLIDE": ["earth_moving", "search_and_rescue", "first_aid"],
            "AVALANCHE": ["mountain_rescue", "first_aid", "thermal_care"],
            "DROUGHT": ["water_trucking", "agriculture_assessment", "relief_distribution"],
            "HEATWAVE": ["medical_triage", "hydration_distribution", "counseling"],
            "COLDWAVE": ["blanket_distribution", "shelter_heating", "medical"],
            "LIGHTNING": ["burn_care", "first_aid", "electrical_safety"],
            "FOREST_FIRE": ["firefighting", "evacuation", "first_aid"],
            "CLOUDBURST": ["rescue_swimmer", "first_aid", "logistics"],
            "GLOF": ["high_altitude_rescue", "logistics", "medical"],
            "INDUSTRIAL_ACCIDENT": ["hazmat", "search_and_rescue", "trauma_care"],
            "CHEMICAL_LEAK": ["hazmat", "toxicology", "evacuation"],
            "GAS_LEAK": ["hazmat", "respiratory_support", "evacuation"],
            "NUCLEAR_INCIDENT": ["radiation_safety", "medical", "evacuation"],
            "BUILDING_COLLAPSE": ["heavy_rescue", "structural_assessment", "first_aid"],
            "MINE_ACCIDENT": ["underground_rescue", "trauma_care", "ventilation"],
            "TRANSPORT_ACCIDENT": ["extrication", "trauma_care", "logistics"],
            "OIL_SPILL": ["environmental_cleanup", "marine_ops"],
            "FIRE_INCIDENT": ["firefighting", "first_aid", "evacuation"],
            "TERROR_ATTACK": ["first_aid", "trauma_care", "psychological_support"],
            "STAMPEDE": ["crowd_control", "first_aid", "trauma_care"],
            "EPIDEMIC": ["epidemiology", "nursing", "public_health"],
            "PANDEMIC": ["quarantine_management", "medical", "vaccination"],
            "OUTBREAK": ["medical", "hygiene_education", "sanitation"],
            "TOXIC_EXPOSURE": ["toxicology", "oxygen_therapy", "first_aid"],
        }
