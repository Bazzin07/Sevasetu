...
class NeedCreate(BaseModel):
    ...
    need_type: Optional[str] = Field(None, pattern="^(HEALTHCARE|EDUCATION|WATER_SANITATION|SHELTER|FOOD|INFRASTRUCTURE|LIVELIHOOD|FLOOD|FLASH_FLOOD|CYCLONE|EARTHQUAKE|TSUNAMI|LANDSLIDE|AVALANCHE|DROUGHT|HEATWAVE|COLDWAVE|LIGHTNING|FOREST_FIRE|CLOUDBURST|GLOF|INDUSTRIAL_ACCIDENT|CHEMICAL_LEAK|GAS_LEAK|NUCLEAR_INCIDENT|BUILDING_COLLAPSE|MINE_ACCIDENT|TRANSPORT_ACCIDENT|OIL_SPILL|FIRE_INCIDENT|TERROR_ATTACK|STAMPEDE|EPIDEMIC|PANDEMIC|OUTBREAK|TOXIC_EXPOSURE)$")
