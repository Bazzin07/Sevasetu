...
# ─── CORS Middleware ─────────────────────────────────────────
# Use allow_origin_regex instead of a fixed list so we cover:
#   • All firebase hosting domains (web.app / firebaseapp.com)
#   • All localhost variants for dev
#   • Any firebase preview channel URLs
# Added LAST = outermost = runs first on requests, last on responses.
CORS_ALLOWED_ORIGINS = [
    "https://sevasetu-242a8.web.app",
    "https://sevasetu-242a8.firebaseapp.com",
...
app.add_middleware(
    ...
    allow_origin_regex=r"https://sevasetu-242a8(--[a-z0-9-]+)?\.web\.app|https://sevasetu-242a8\.firebaseapp\.com|http://localhost:\d+|http://127\.0\.0\.1:\d+",
    allow_credentials=True,
    allow_methods=["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"],
    allow_headers=["*"],
    expose_headers=["*"],
    max_age=86400,  # Cache preflight for 24h — reduces OPTIONS round-trips
)
