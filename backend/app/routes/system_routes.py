...
async def service_status():
    ...
    return {
        ...
        "secret_manager": _secret_manager_status(),
    }


def _secret_manager_status() -> dict:
    try:
        from app.services.secret_manager_service import secret_manager_service
        return secret_manager_service.status()
